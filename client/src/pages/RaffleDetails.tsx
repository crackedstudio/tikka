    ...
    return (
        <div className="w-full mx-auto max-w-7xl px-6 md:px-12 lg:px-16 flex flex-col">
            ...
            <div className="bg-[#11172E] rounded-3xl p-6 mb-6">
                <h3 className="text-xl font-bold text-white mb-4">Raffle Details</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div className="flex justify-between border-b border-[#1F263F] pb-2">
                        <span className="text-gray-400">Status</span>
                        <span className="text-white font-medium">{statusLabel}</span>
                    </div>
                    <div className="flex justify-between border-b border-[#1F263F] pb-2">
                        <span className="text-gray-400">Ticket Price</span>
                        <span className="text-white font-medium">{raffle.ticketPriceFormatted}</span>
                    </div>
                    <div className="flex justify-between border-b border-[#1F263F] pb-2">
                        <span className="text-gray-400">Tickets Sold</span>
                        <span className="text-white font-medium">{raffle.totalTicketsSold} / {raffle.maxTickets}</span>
                    </div>
                    <div className="flex justify-between border-b border-[#1F263F] pb-2">
                    ...
                    <div className="flex justify-between border-b border-[#1F263F] pb-2">
                        ...
                        <span className="text-white font-medium">{raffle.metadata?.category || "General"}</span>
                    </div>
                </div>
                ...
                <div className="mt-6">
                    {isFinalized ? (
                        <button
                            className="border border-[#fe3796] px-8 py-3 rounded-xl hover:bg-[#fe3796]/10 transition"
