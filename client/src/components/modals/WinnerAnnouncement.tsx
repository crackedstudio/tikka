...
export const AnimationPanel: React.FC<AnimationPanelProps> = ({ isVisible }) => {
    ...
    // This panel is purely a side-effect trigger; it renders nothing visible.
    return null;
};

// ---------------------------------------------------------------------------
// getSocialIcon  (kept as a module-level helper — not a component)
// ---------------------------------------------------------------------------
...
const WinnerAnnouncement: React.FC<WinnerAnnouncementProps> = ({
    ...
    return (
        <>
            <AnimationPanel isVisible={isVisible} />
            <ResultPanel
                prizeName={prizeName}
