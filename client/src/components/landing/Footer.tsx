        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-[#CCCCCC] mb-10">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <img src={logo} alt="VeriWin logo" className="h-7 w-auto" />
              <img
                src={tikka}
            ...
            <p className="text-sm">
              Host raffles, join raffles, and enjoy the thrill of fair play—all
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="#" aria-label="Twitter / X">
                <img src={TwitterLogo} alt="Twitter / X" className="h-6 w-6" />
              </a>
