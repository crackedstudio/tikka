      ...
      <div className="bg-white dark:bg-[#1E1932] rounded-xl p-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            aria-expanded="false"
            aria-label="Expand player stats"
          >
    ...
    <div className="bg-white dark:bg-[#1E1932] rounded-xl p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="text-gray-400 hover:text-gray-900 dark:text-white transition-colors"
          aria-expanded="true"
          aria-label="Collapse player stats"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            <path
              fillRule="evenodd"
      ...
      <div className="mb-6">
        ...
        <button
          className="w-full bg-yellow-500 hover:bg-yellow-600 text-gray-900 dark:text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200"
          aria-label="Claim 25 XP daily login bonus"
        >
          Claim 25 XP Bonus!
        </button>
      </div>
